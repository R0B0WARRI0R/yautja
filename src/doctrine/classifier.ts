...
const LEGACY_MAP: Record<ArsenalErrorType, string> = {
  ...
  SCREENSHOT_TOO_LARGE: 'YJ.CAPTURE.CONTEXT_BUDGET_EXCEEDED',
  REF_NOT_FOUND: 'YJ.ACT.DOM_TARGET_STALE',
  TAB_OUTSIDE_GROUP: 'YJ.POLICY.GATE_DENIED',
  TAB_OWNED_BY_OTHER_SESSION: 'YJ.POLICY.GATE_DENIED',
  FEATURE_DISABLED: 'YJ.POLICY.FEATURE_DISABLED',
  EXTENSION_LINK_DEGRADED: 'YJ.NET.EXTENSION_LINK_DEGRADED',
